...
class Organization:
    ...
    def __init__(self,client_id, client_secret,org_id,env_requested):
        ...
        url_env = "https://anypoint.mulesoft.com/accounts/api/profile"
    #    print(url)
    ...
    #    print(response2.status_code)
        if response2.status_code == 200:
            ...
            for environment in response_json["organization"]["environments"]:
...
parser.add_argument("--k", required=True, help="CLIENT_ID")
parser.add_argument("--s", required=True, help="CLIENT_SECRET")
...
org = Organization(args.k,args.s,args.o,args.e)
